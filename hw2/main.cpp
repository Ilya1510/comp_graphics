...
int main()
{
    ...
    auto[FriendID, FriendMatrixID] = initTextureShader();
    auto[EnemyID, EnemyMatrixID] = initTextureShader();
    auto[SphereID, SphereMatrixID] = initTextureShader();

	// Load the texture
	// Get a handle for our "myTextureSampler" uniform
	GLuint SphereTexture = loadDDS("picture/rainbow.dds");
	GLuint SphereTextureID = glGetUniformLocation(SphereID, "myTextureSampler");

    GLuint EnemyTexture = loadDDS("picture/sun.dds");
    GLuint EnemyTextureID = glGetUniformLocation(EnemyID, "myTextureSamplerEnemy");

    GLuint FriendTexture = loadDDS("picture/sun.dds");
    GLuint FriendTextureID = glGetUniformLocation(EnemyID, "myTextureSamplerEnemy");
