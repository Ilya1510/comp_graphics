...
int main( void )
{
	...
	GLuint programIDRed = LoadShaders( "SimpleTransform.vertexshader", "RedFragmentShader.fragmentshader" );
    GLuint programIDGreen = LoadShaders( "SimpleTransform.vertexshader", "GreenFragmentShader.fragmentshader" );
	...
	do{
        ...
        glm::mat4 Projection = glm::perspective(45.0f + counter / 100, 4.0f / 3.0f + counter / 1000, 0.1f, 100.0f);
        // Or, for an ortho camera :
        //glm::mat4 Projection = glm::ortho(-10.0f,10.0f,-10.0f,10.0f,0.0f,100.0f); // In world coordinates

        // Camera matrix
        glm::mat4 View       = glm::lookAt(
                glm::vec3(counter / 4 - 10,counter / 10,counter / 10), // Camera is at (4,3,3), in World Space
                glm::vec3(0 + (counter / 20),counter / 100,counter / 40), // and looks at the origin
